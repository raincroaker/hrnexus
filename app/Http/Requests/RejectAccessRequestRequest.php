...
class RejectAccessRequestRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // Only admin and department managers can reject access requests
        ...
        // Department Manager can only reject requests for documents in their department
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($accessRequest->status !== 'pending') {
                $validator->errors()->add('status', 'Only pending access requests can be rejected.');
            }
        });
    }
